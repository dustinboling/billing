  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved plan as @plan" do
        ...
        post :create, {:plan => { "stripe_id" => "invalid value" }}, valid_session
        assigns(:plan).should be_a_new(Plan)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested plan" do
        ...
        Plan.any_instance.should_receive(:update).with({ "stripe_id" => "MyString" })
        put :update, {:id => plan.to_param, :plan => { "stripe_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the plan as @plan" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Plan.any_instance.stub(:save).and_return(false)
        put :update, {:id => plan.to_param, :plan => { "stripe_id" => "invalid value" }}, valid_session
        assigns(:plan).should eq(plan)
      end
